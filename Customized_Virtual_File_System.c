...
void SetEnvironment()
{
	...
	printf("Environment for the @Shubham's Virtual File System is set...\n");
} 
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
int main()
{
	...
	printf("\n$$$$$$$$$$$$$$$$$$$$$$$__________Jay Shree Ram__________$$$$$$$$$$$$$$$$$$$$$$$$\n\n");
	printf("\t\t\t\t   Welcome to");
	printf("\n________________________ @Shubham's Virtual File System ________________________\n\n");
	SetEnvironment();
...
//------------------------------------------------------------------------------------------------------------------------------
		...
		if(count == 1)
		{
			...
			else if(strcmp(command[0],"exit")==0)
			{
				...
				printf("\nAre you sure to exit this Shubham's VFS ?(Y/N)\n");
				scanf("%c",&ch);
				if(ch=='Y'||ch=='y')
				{
					printf("\t\t\t\t   THANK YOU");
					printf("\n__________________________ FOR USING THIS APPLICATION __________________________\n\n");
					printf("$$$$$$$$$$$_____ Terminating the @Shubham's Virtual File System _____$$$$$$$$$$$\n\n");
